...
pub fn build(b: *std.Build) void {
    ...
    // Cleans the cache folders generated by ziglang
    const clean = b.addExecutable(.{ .name = "clean", .root_source_file = .{ .path = "src/bin/delete-zig-cache.zig" }, .target = target, .optimize = optimize });
    b.installArtifact(clean);
